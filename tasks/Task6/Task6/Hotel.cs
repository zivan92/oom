...
namespace Task6
{
    public class Hotel : HotelZimmer
    {
        private int anzahl;
        ...
        public void Zimmer(string Paketname)
        {
            Console.WriteLine($"Mein Hotel bekommt das Zimmer " + Paketname);
            
        }
        
        
      
        public Hotel(double Zimmerpreis, int Anzahl, string GebuchtVon)
        {
